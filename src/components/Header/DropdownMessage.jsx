  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative z-100 bg-gray-800 bg-opacity-50">
      <li className="relative">
        ...
        {dropdownOpen && (
          <div
            className={`absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-gray-800 bg-opacity-50 shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80`}
          >
